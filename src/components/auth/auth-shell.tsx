...
export function AuthShell({
  ...
  return (
    <div className="grid min-h-screen place-items-center bg-gradient-to-br from-green-50 via-lime-50 to-white dark:from-slate-950 dark:via-green-950/20 dark:to-slate-900 px-3 py-6 sm:px-4">
      <Card className="w-full max-w-md shadow-2xl border-slate-200/50 dark:border-slate-800/50">
        <CardHeader className="space-y-2 sm:space-y-3 p-4 sm:p-6">
          <div className="mb-1 sm:mb-2 flex items-center gap-2">
            <div className="p-1.5 sm:p-2 rounded-lg bg-gradient-to-br from-green-500 to-lime-600">
              <Hospital className="h-4 w-4 sm:h-5 sm:w-5 text-white" />
            </div>
            <span className="font-bold text-base sm:text-lg bg-gradient-to-r from-green-600 to-lime-700 dark:from-green-400 dark:to-lime-400 bg-clip-text text-transparent">NMSL App</span>
          </div>
