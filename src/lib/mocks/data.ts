...
export const mockUsers: User[] = [
  ...
  },
  {
    ...
    location: "Abuja",
    state: "FCT",
    address: "3 Constitution Avenue, Central District",
    idNumber: "AD-2026-00006",
    phone: "+234 803 456 7890",
...
export const mockStatistics: Statistic[] = [
  { id: "stat-1", value: "45+", label: "Years of Service", sublabel: "Serving since 1978", icon: "clock" },
  { id: "stat-2", value: "6", label: "Locations", sublabel: "Across Nigeria", icon: "building" },
  { id: "stat-3", value: "100+", label: "Specialists", sublabel: "Expert healthcare professionals", icon: "users" },
  { id: "stat-4", value: "ISO 9001:2015", label: "Certified", sublabel: "Quality Standards", icon: "award" },
];
